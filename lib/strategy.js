...
OAuth2Strategy.prototype.generatePKCEPair = function(pkceMethod) {
  ...
  case 'S256':
    ...
    break;
  default:
    throw new Error('Unsupported code verifier transformation method: ' + pkceMethod);
  }
...
OAuth2Strategy.prototype.authenticate = function(req, options) {
  ...
  if ((req.query && req.query.code) || (req.body && req.body.code)) {
    ...
    if (this._pkceMethod) {
      try {
        var pair = this.generatePKCEPair(this._pkceMethod);
    ...
    if (state && typeof state == 'string') {
      ...
      var parsed = this.buildAuthorizeUrl(params);
      ...
      function stored(err, state) {
        ...
        var parsed = self.buildAuthorizeUrl(params);
        var location = url.format(parsed);
...
OAuth2Strategy.prototype.buildAuthorizeUrl = function (params) {
  console.log('OAuth2Strategy.prototype.buildAuthorizeUrl', params);
